...
public class FoodCatalougeServiceTest {
    ...
    @InjectMocks
    private FoodCatalougeService foodCatalogueService;
    ...
    void fetchFoodCataloguePageDetails_ShouldReturnFoodCataloguePage() {
        ...
        // Act
        FoodCatalougePage result = foodCatalogueService.fetchFoodCataloguePageDetails(restaurantId);
